...
public interface MessageMapper {
    ...
    @Results({
            @Result(property = "replays", column = "temp_id", many = @Many(select = "com.bluesky.em.mapper" +
    ...
    @Results({
            @Result(property = "replays", column = "id", many = @Many(select = "com.bluesky.em.mapper.ReplayMapper" +
                    ".findAllById"))
    })
